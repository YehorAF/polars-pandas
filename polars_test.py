...
agg_by_part_df = df.group_by("part_num").agg(
...
agg_by_inventory_df = df.group_by("inventory_id").agg(
...
print("Memory (Bytes): ", tracemalloc.get_traced_memory())
